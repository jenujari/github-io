...
import { faFireAlt,faAngleDoubleRight,faUser,faGraduationCap ,faIdCard} from '@fortawesome/free-solid-svg-icons'
        ...
        <ul className="navbar-nav">
          <li className="logo">
            <a href="#" className="nav-link">
              <span className="link-text logo-text">Cats</span>
...
<header className="App-header">
        <img src={IMAGE_SQ} className="App-logo" alt="logo" />
        <h1>
          Namaskar 🙏 | I'm Jenish Jariwala
        </h1>
        <p>
          I'm a {' '}
          <Typical
